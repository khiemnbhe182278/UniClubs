    ...
    <body>
        ...
        <div class="container">
            <div class="form-card">
                ...
                <form method="post" action="${pageContext.request.contextPath}/leader/update-news">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               maxlength="200"
                               required>
                        <div class="char-count" id="titleCount">${news.title.length()}/200</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="char-count" id="contentCount">${news.content.length()} characters</div>
                    </div>
