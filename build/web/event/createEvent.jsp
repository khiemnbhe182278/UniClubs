            ...
            <form id="eventForm" action="createEvent" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="eventName" name="eventName" required value="<%= request.getAttribute("eventName") != null ? request.getAttribute("eventName") : "" %>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="4" required><%= request.getAttribute("description") != null ? request.getAttribute("description") : "" %></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" id="eventDate" name="eventDate" required value="<%= request.getAttribute("eventDate") != null ? request.getAttribute("eventDate") : "" %>">
                    </div>
