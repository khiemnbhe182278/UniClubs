                ...
                <div id="viewMode">
                    <div class="content-body">
                        <div class="rule-section">
                            <div class="rule-title-display">${rule.title}</div>
                            <div class="section-header">
                                <h2 class="section-title">Rule Content</h2>
                            </div>
                            <div class="rule-content-display">${rule.ruleText}</div>
                        </div>
                        ...
                        <div class="metadata-section">
                            <div class="metadata-grid">
                                ...
                                <div class="metadata-item">
                                    ...
                                    <div class="metadata-value">#${rule.ruleID}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="action-section">
                            <div class="action-buttons">
                                <button class="btn-custom btn-primary-custom" onclick="enableEditMode()">Edit Rule</button>
                                <a href="${pageContext.request.contextPath}/rule/delete?id=${rule.ruleID}&clubID=${rule.clubID}" 
                                   class="btn-custom btn-danger-custom"
                                   onclick="return confirm('Are you sure you want to delete this rule?');">Delete Rule</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form id="editMode" class="edit-mode" method="post" 
                    ...
                    <div class="form-section">
                        <div class="form-group-custom">
                            <label class="form-label-custom" for="title">Rule Title</label>
                            <input type="text" 
                                   class="form-input" 
                                   id="title" 
                                   name="title" 
